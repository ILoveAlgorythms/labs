...
%% чтобы картинки норм вставлялись
\usepackage{floatrow}

% %dark theme
% \usepackage{xcolor}
% \pagecolor[rgb]{0.16,0.176,0.243} 
% \color[rgb]{1,1,1}

%%% Работа с русским языком
\usepackage{cmap}					% поиск в PDF
\usepackage{mathtext} 				% русские буквamsmathы в формулах
\usepackage[T2A]{fontenc}			% кодировка %Т1 посоветовал чат гпт
